...
const int LightsMorningONhour = 10; const int LightsMorningONminute = 15; const int LightsMorningONsec = 3;
const int LightsMorningOFFhour = 10; const int LightsMorningOFFminute = 25; const int LightsMorningOFFsec = 3;
const int LightsEveningONhour = 10; const int LightsEveningONminute = 35; const int LightsEveningONsec = 3;
const int LightsEveningOFFhour = 10; const int LightsEveningOFFminute = 45; const int LightsEveningOFFsec = 3;
...
void Watering() {
 ...
 const unsigned long TimeLightONminute = (LightsMorningONminute) * 60000L;
  const unsigned long TimeLightONsec = (LightsMorningONsec) * 1000L;
  // Lights OFF Evening
...
void loop () {
  ...
  if ((unsigned long)(currentMillis1 - previousMillisUpdate1) >= intervallUpdate) {
    ...
    previousMillisUpdate1 = currentMillis1;
     ...
     client.publish("Sensors",TSL2561.readVisibleLux());
    client.publish("Sensors","5 °C");
    client.loop();
