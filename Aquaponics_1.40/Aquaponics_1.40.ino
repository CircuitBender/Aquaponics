...
uint32_t LightsMorningONhour = 10; uint32_t LightsMorningONminute = 1; uint32_t LightsMorningONsec = 3;
...
uint32_t LightsEveningOFFhour = 22; uint32_t LightsEveningOFFminute = 30; uint32_t LightsEveningOFFsec = 3;

// Lights ON Morning
uint32_t TimeON = (((LightsMorningONhour) * 3600000L) + ((LightsMorningONminute) * 60000L) + ((LightsMorningONsec) * 1000L)) * 1L;
// Midday
uint32_t TimeRainON = (((LightsMorningOFFhour) * 3600000L) + ((LightsMorningOFFminute) * 60000L) + ((LightsMorningOFFsec) * 1000L)) * 1L;
// AFternoon
uint32_t TimeRainOFF = (((LightsEveningONhour) * 3600000L) + ((LightsEveningONminute) * 60000L) + ((LightsEveningONsec) * 1000L)) * 1L;
// Lights OFF Evening
uint32_t TimeOFF = (((LightsEveningOFFhour) * 3600000L) + ((LightsEveningOFFminute) * 60000L) + ((LightsEveningOFFsec) * 1000L)) * 1L;
...
uint32_t CycleTime = (11 * 60 * 1000L);
uint32_t CycleTimeHigh = (300 * 1000L);
uint32_t NTPupdateTime = (6 * 60 * 1000L);
uint32_t SensorCycle = 10013;
uint32_t manualUpdate = 10000;
uint32_t FeedingQuantity = 34000;
/*
uint32_t Sunset = (15 * 60000L);
uint32_t Sunrise = (15 * 60000L);
...
uint32_t previousMillisafterSunset = 0;
uint32_t previousMillisafterSunrise = 0;
