...
uint32_t LightsMorningONhour = 9; uint32_t LightsMorningONminute = 35; uint32_t LightsMorningONsec = 3;
uint32_t LightsMorningOFFhour = 14; uint32_t LightsMorningOFFminute = 15; uint32_t LightsMorningOFFsec = 3;
uint32_t LightsEveningONhour = 15; uint32_t LightsEveningONminute = 15; uint32_t LightsEveningONsec = 3;
uint32_t LightsEveningOFFhour = 21; uint32_t LightsEveningOFFminute = 30; uint32_t LightsEveningOFFsec = 3;
...
#define TechnoAir2_Relais12 33  //  Ventilation LED OUT 
...
void setup_relays() {
  ...
  pinMode(AquaAir1_Relais12, OUTPUT);

  pinMode(AquaAir2_Relais13, OUTPUT);
