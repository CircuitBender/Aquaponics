...
/* <<<<<<<<<<<< Aquaponics 1.04 by Marco Heinzen >>>>>>>>>>>>>>>>>>>
      _ _
     _{ ' }_
    { `.!.` }
    ',_/Y\_,'
...
const int LightsMorningONhour = 9;
const int LightsMorningONminute = 30;
const int LightsMorningONsec = 0;
const int LightsMorningOFFhour = 14;
const int LightsMorningOFFminute = 0;
const int LightsMorningOFFsec = 0;

const int LightsEveningONhour = 15;
...
const int WateringONhour = 13;
const int WateringONminute = 3;
...
const long CycleTime = 80000L;

const long NTPupdateTime = 60000L;
...
void setup()
{
  Serial.begin(9600);
        ...
        Serial.println("Aquaponics 1.04");
...
WACY =  Alarm.timerRepeat(CycleTime, TimerWACY);      // timer for the ebb/ flow cycle
        Serial.print("Watering Cycle Time:");
...
const long NTPupdateTime = 60000L; 
NTPUD = Alarm.timerRepeat(NTPupdateTime, NTPupdate);
...
{ 
 ...
 /* if (WateringONhour >= hour() < WateringOFFhour) {
  Alarm.enable(WateringCycle);
 }
 else {
 Alarm.disable(WateringCycle);
 };
