...
const long FlowbackTime = 76000L;
const long CycleTime = 300030L;
...
const int SensorReading = t.every(15000, readSensors);
...
VRT1 = analogRead(A0);              //Acquisition analog value of VRT
  ...
  WaterTemperature = TX1 -5; // Calibration
