...
const unsigned long CycleTime = 900000L;
const unsigned long CycleTimeHigh = 180000L;
...
unsigned long TimeON = (TimeLightONhour+TimeLightONminute+TimeLightONsec)*1L;
 Serial.print(TimeON);
  Serial.println(" TimeON in ms ");
unsigned long TimeOFF = (TimeLightOFFhour+TimeLightOFFminute+TimeLightOFFsec)*1L;
 Serial.print(TimeOFF);
  Serial.println(" TimeOFF in ms ");
unsigned long TimeRainON = (TimeRainONhour+TimeRainONminute+TimeRainONsec);
 Serial.print(TimeRainON);
  Serial.println(" TimeRainON in ms ");
unsigned long TimeRainOFF = (TimeRainOFFhour+TimeRainOFFminute+TimeRainOFFsec);
