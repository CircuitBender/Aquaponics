...
#define DS1302_SCLK_PIN   21    // Arduino pin for the Serial Clock
#define DS1302_IO_PIN     22    // Arduino pin for the Data I/O
#define DS1302_CE_PIN     23    // Arduino pin for the Chip Enable
...
#define SET_DATE_TIME_JUST_ONCE
  ...
  dayofmonth = 06; // Day of month, 1...31
  month      = 4;  // month 1...12
  year       = 2017;
