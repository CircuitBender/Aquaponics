...
SFE_TSL2561 lightSensor1;
SFE_TSL2561 lightSensor2;
...
void setup()
{
  ...
  // You can pass nothing to lightSensor1.begin() for the default I2C address (0x39),
  ...
  lightSensor1.begin(0x39);
  lightSensor2.begin(0x29);
  ...
  {
    byte error = lightSensor1.getError();
    printError(error);
  }
  ...
  {
    byte error = lightSensor2.getError();
    printError(error);
  }
  ...
  // If gain1 = false (0), device is set to low gain (1X)
  // If gain1 = high (1), device is set to high gain (16X)
...
void loop()
{
  ...
  if (lightSensor1.getData(data0,data1))
  {
    ...
    good = lightSensor1.getLux(gain1,ms1,data0,data1,lux);
  ...
  if (lightSensor2.getData(data2,data3))
  {
    // getData() returned true, communication was successful
    ...
    good = lightSensor2.getLux(gain1,ms1,data0,data1,lux2);
