...
uint32_t LightsMorningONhour = 10; uint32_t LightsMorningONminute = 15; uint32_t LightsMorningONsec = 3;
...
#define Fishfeeder 29  // 3.3v Fishfeeder Relay
...
Task t5(FeedingCycle, TASK_FOREVER, &Feeding, &hpr);
