...
const unsigned long CycleTime = 1203017L;
const unsigned long NTPupdateTime = 181011L;
...
Task t1(SensorCycle, TASK_FOREVER, &readSensors);
Task t2(CycleTime, TASK_FOREVER, &abc);
Task t3(NTPupdateTime, TASK_FOREVER, &getNtpTime);
